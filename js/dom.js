...
//ingreso datos al storage
const formatoJSON = JSON.stringify(muzzarella);
console.log(formatoJSON);
const formatoJson2= JSON.stringify(napolitana);
console.log(formatoJSON);
//extraigo datos del storage y los convierto en objetos Js.
const formatoJs = JSON.parse(formatoJSON);
const formatoJs2 = JSON.parse(formatoJson2);
console.log(formatoJs);
console.log(formatoJs2);
...
function tomarPedidos() {
 ...
 boton.addEventListener("click", tomarPedidos)


//funcion para agragar elementos al html por DOM
